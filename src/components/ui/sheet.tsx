...
const SheetOverlay = ({ className, ref, ...props }: ComponentProps<"div">) => (
...
const SheetContent = ({
  ...
  ref,
  ...props
}: VariantProps<typeof sheetVariants> & ComponentProps<"div">) => (
  <SheetPortal>
    <SheetOverlay />
...
const SheetTitle = ({ className, ref, ...props }: ComponentProps<"h2">) => (
